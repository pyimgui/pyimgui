cdef extern from "imgui_internal.h":
    ...
    ctypedef enum ImGuiItemFlags_:
        ...
        ImGuiItemFlags_Default_                 # remove in v 1.83
    ...
    ctypedef enum ImGuiButtonFlagsPrivate_:
        ...
        ImGuiButtonFlags_AllowOverlap           # require previous frame HoveredId to either match id or be null before being usable, use along with SetItemAllowOverlap() # rename at v1.89.9
        ImGuiButtonFlags_DontClosePopups        # disable automatically closing parent popup on press // [UNUSED]
        # ImGuiButtonFlags_Disabled               # disable interactions # disable in v1.84
    ...
    ctypedef enum ImGuiTooltipFlags_:
        ...
        ImGuiTooltipFlags_OverridePrevious  # Override will clear/ignore previously submitted tooltip (defaults to append) # rename in v1.89.9
    ...
    ctypedef enum ImGuiInputSource:
        ...
        # ImGuiInputSource_Nav            # Stored in g.ActiveIdSource only # remove in v1.89.9
        ImGuiInputSource_COUNT

    # FIXME-NAV: Clarify/expose various repeat delay/rate
    # ctypedef enum ImGuiInputReadMode: # renamed to `ImGuiNavReadMode` in v1.87
    ...
    # ctypedef enum ImGuiNavReadMode: # renamed from `ImGuiInputReadMode` in v1.87 # removed in v1.89, new enum `ImGuiInputReadFlags_`
    ...
    #
    # ctypedef ImGuiNavReadMode ImGuiInputReadMode; # forward compatibility with old code
    ...
    # ctypedef enum ImGuiNavDirSourceFlags_: # remove in v1.89
    ...
    ctypedef enum ImGuiNavMoveFlags_:
        ...
        ImGuiNavMoveFlags_ScrollToEdgeY         # rename from `ImGuiNavMoveFlags_ScrollToEdge` in v1.85
        ImGuiNavMoveFlags_Forwarded             # add in v1.85
        ImGuiNavMoveFlags_DebugNoResult         # add in v1.85
        ImGuiNavMoveFlags_FocusApi              # add in v1.89.9
        ImGuiNavMoveFlags_IsTabbing             # add in v1.85
        ImGuiNavMoveFlags_IsPageMove            # add in v1.89.9
        ImGuiNavMoveFlags_Activate              # add in v1.85
        ImGuiNavMoveFlags_NoSelect              # add in v1.89.9
        ImGuiNavMoveFlags_NoSetNavHighlight     # add in v1.85

    # ctypedef enum ImGuiNavForward: # remove in v1.85
